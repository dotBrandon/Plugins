...
// End Cross Module References
	...
	struct Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_PhantomTrackMode_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PhantomTrackMode_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_PhantomTrackMode;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::NewProp_PhantomTrackMode_MetaData[] = {
		{ "Category", "ACL Options" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::NewProp_PhantomTrackMode = { "PhantomTrackMode", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimBoneCompressionCodec_ACLBase, PhantomTrackMode), Z_Construct_UEnum_ACLPlugin_ACLPhantomTrackMode, METADATA_PARAMS(Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::NewProp_PhantomTrackMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::NewProp_PhantomTrackMode_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::NewProp_PhantomTrackMode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimBoneCompressionCodec_ACLBase_Statics::NewProp_PhantomTrackMode,
	...
	IMPLEMENT_CLASS(UAnimBoneCompressionCodec_ACLBase, 12628407);
